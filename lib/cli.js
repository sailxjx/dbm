...
(function() {
  ...
  commander.version(pkg.version).usage('[options] [command]').option('--ext <ext>', 'extension of migration files').option('--db <db>', 'connection of migration db').option('--dir <dir>', 'directory for saving migration files').option('--file <file>', 'the file to saving migration status');
